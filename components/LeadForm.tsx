        ...
        >
          ...
          <div className="space-y-3 border-t border-white/8 pt-8">
            <a
              ...
              className="flex items-center gap-3 font-josefin text-sm text-cream/70 hover:text-sea transition-colors duration-300 group"
            >
              <span className="w-6 h-px bg-white/20 group-hover:bg-sea transition-colors duration-300" />
        ...
        >
          {enviado ? (
            <motion.div
              ...
              className="border border-sea/30 bg-white/[0.03] p-10 text-center"
            >
              <p className="font-cormorant italic text-3xl text-sea mb-3">Obrigado!</p>
            ...
            >
              ...
              <button
                type="submit"
                className="group w-full flex items-center justify-center gap-3 bg-sea text-bg font-josefin text-[11px] tracking-w3 uppercase py-4 hover:bg-cream transition-all duration-300"
              >
